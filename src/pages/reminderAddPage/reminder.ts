    ...
    return `<form id="main-form service" class="main-form service" action="/" method="put">    
      ...
      ${lineOfEvent('service', 'name', eventLang().name, icon.pen, 'text')}
        ...
        <div id="service__total_container" class="service__total_container">
              ${lineOfEvent('service', 'cost-works', eventLang().costWorks, icon.cost, 'number', getMoney('BY'))}
                ${lineOfEvent('service', 'total', eventLang().amount, icon.wallet, 'number', getMoney('BY'))}
        </div>
        <div id="service__time_container" class="service__time_container">
                ...
                ${lineOfEvent('service', 'mileage', eventLang().mileage, icon.mileage, 'number')}
        </div>
          ${lineOfEvent('service', 'place', eventLang().place, icon.place, 'text')}
          ${lineOfEvent('service', 'notes', eventLang().comments, icon.comments, 'text')}
