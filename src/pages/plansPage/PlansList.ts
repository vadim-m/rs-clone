export class PlansList {
  ...
  createElement() {
    ...
    <ul class="plans__list grid gap-y-3 mb-4 dark:text-black">
      <li class="plans__item relative bg-myslate rounded-lg flex justify-between gap-x-2 items-center py-2 pl-4 pr-2 shadow-md dark:bg-slate-400 dark:shadow-inner">
        ...
        <div class="plans__item-and-icon flex items-center mr-2">
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="plans__image w-7 h-7 mr-4 fill-black"
