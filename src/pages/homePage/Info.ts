...
import { getCarFromLS, getCarInfoFromLS } from '../../helpers/localStorage';
import { setLogo } from '../../helpers/utils';
import { eventLang } from '../../lang/addEventLang';
import { curSpendMonth } from '../../utilits/mathSpend';
        ...
        <div class="info__car car bg-myslate rounded-lg shadow-md mb-4 p-4 grid-cols-2 gap-x-2 dark:bg-slate-700">
          ...
          <div>
            <div class="info__stats grid grid-cols-2 gap-4 mt-2">
              <div class="info__expenses flex gap-3 items-center bg-white p-1 drop-shadow-md pl-2 dark:bg-slate-500 rounded-lg">
                ...
                <div class="expenses">
                  ...
                  <div class="expenses__amount text-xxs">
                    <span class="expenses__sum">${curSpendMonth(
                      this.carData as ICarData
                    )}</span><span class="expenses__currency"> ₽</span>
                  </div>
                </div>
              </div>

              <div class="info__petrol flex gap-3 items-center bg-white p-1 drop-shadow-md pl-2 dark:bg-slate-500 rounded-lg">
                ...
                <div class="petrol">
                  ...
                  <div class="text-xxs">
                    <span>${this.carData?.indicators.curMileage}</span> ${eventLang().km} 
                  </div>
                </div>
              </div>

              <div class="info__petrol flex gap-3 items-center bg-white p-1 drop-shadow-md pl-2 pr-2 dark:bg-slate-500 rounded-lg">
              ...
              <div class="info__petrol flex gap-3 items-center bg-white p-1 drop-shadow-md pl-2 dark:bg-slate-500 rounded-lg">
                ...
                <div class="petrol">
                  ...
                  <div class="petrol__amount text-xxs">
                    <span class="petrol__sum">${
                      this.carData?.indicators.curConsumptionFuel
                    }</span><span class="petrol__currency"> ${eventLang().l100}</span>
                  </div>
                </div>
              </div>
            </div>
