...
export function lineOfEvent(event: string, paramsObj: IParamsLineOfEvent) {
  return `  <div class="${event}__item ${event}__item_${paramsObj.idAndClass}
            flex flex-col relative w-${paramsObj.size} z-1">
                ...
                <input id="${event}__input_${paramsObj.idAndClass}"
                       ...
                       flex m-0 border-b-2 border-slateBorders focus:border-green-400 text-gray-600 placeholder-gray-400 outline-none h-6 pl-2 ml-6 align-baseline"
